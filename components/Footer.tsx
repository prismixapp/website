...
const navigation = {
  ...
  social: [
    {
      name: "Discord",
      href: "https://discord.gg/wjJWBMdBHG",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg width="71" height="55" viewBox="0 0 71 55" fill="none" {...props}>
          <g clipPath="url(#discordclip)">
            <path
