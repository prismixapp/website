      ...
      <div className="relative py-16 bg-white overflow-hidden">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            ...
            <h2>Accounts</h2>
            <p>
              When you create an account, you guarantee that you are above the
              age of thirteen (13) and that the information you provide us is
            ...
            <p>
              ...
              under your account and/or password. You must notify us immediately
            ...
            <p>
              ...
              or edit content, or cancel orders.
            </p>
            <p>
